	...
	<div class="formbody">
		...
		<div class="toolsli">
			<ul class="forminfo">
				...
				<li>
					<label>代理时间 :<b>*</b></label>
					<input name="" id="proxyTime" type="text" class="dfinput" readonly="readonly" style="width: 345px;" />
				</li>
				<li>
					<label>代理人 :<b>*</b></label>
					<input name="" id="proxy" type="text" class="dfinput" readonly="readonly" style="width: 345px;" />
			...
			<div class="tipbtn">
				...
				<input name="" type="button" class="cancel" onclick="javascript:window.history.back(-1);" value="取消" />
			</div>
		</div>
	</div>
	
	<div class="tip">
    	<div class="tiptop"><span>查询代理人信息</span><a></a></div>
        <div class="tipbtn">
