...
<body>
		...
		<div id="usual1" class="usual">
			...
			<div class="tabson">
				<div class="tools">
					<ul class="toolbar">
						<li class="click">
							<a href="${ctx}/system/smsTemplate_input.jsp">
						...
						<li class="click">
							<a href="${ctx }/system/smsTemplate_setting.jsp"><span><img src="${cdnPrefix}/template/images/t05.png" /></span>短信配置</a>
						</li>
					</ul>
				</div>
	...
	<script type="text/javascript">
		...
		function sms(){
			window.location.href="${ctx }/system/smsTemplate.jsp"
		}
	</script>
</body>
</html>