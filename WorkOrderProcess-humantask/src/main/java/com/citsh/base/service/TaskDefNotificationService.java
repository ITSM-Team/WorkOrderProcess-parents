...
{
  public abstract List<TaskDefNotification> findByBaseCodeAndBaseProcessId(String paramString, Object[] paramArrayOfObject);

  public abstract TaskDefNotification findByBaseCodeAndBaseProcessIdOne(String paramString, Object[] paramArrayOfObject);
